    ...
    return (
        <section className="flex flex-row py-6 px-8 h-4/5 text-blueGray-900">
            <div className="w-4/5 mr-8">
                <strong className="text-2xl font-semibold">Revisa y confirma tu compra</strong>
                ...
                <div className="flex flex-col border border-blueGray-400 px-4 py-4 mt-8 bg-blueGray-100">
                    <h2 className=" text-green-800 text-lg font-semibold mb-6">Fecha de entrega: ___________</h2>
                    <div className="flex-grow flex flex-row ml-4">
                        ...
                        <div className="ml-4 flex flex-col justify-beetwen">
                            ...
                            <p className="text-sm text-blueGray-700 mb-2">Vendido por <em>Nombre de la Tienda</em> </p>
                        </div>
                    </div>
            ...
            <div className="flex flex-col justify-around w-1/5 border border-blueGray-400 p-4 h-full mt-14 bg-blueGray-100">
                <button className="button theme px-4 text-base mb-4">Confirmar compra</button>
                <h2 className=" font-semibold mb-4">Resumen del pedido</h2>
                <p>Productos: <strong className="ml-8">$0.00</strong></p>
                <p>Envío: <strong className="ml-16">$0.00</strong></p>
                <strong className="text-red-800 border-t-2 border-blueGray-500 text-xl pt-2 mt-2">Total $0.0</strong>
            </div>
        </section>
    )
}
